(function(f) {
  ...
  viz.biPartite = function(){
	  ...
	  biPartite.duration = function(_){
		return arguments.length ? (duration = _, refresh=true, biPartite) : typeof duration=="undefined" ? (duration=0):duration;
	  }
...
/*	  if(!arguments.length) return typeof fill !== "undefined" ? fill : function(d){ return '#000'; } ;
  ...
  function viz_schemeCategory10(){ return d3.scale.ordinal().range(d3.schemeCategory10) }
